...
CASES = [
    ...
    ("reset_mid_line", f"{ESC}[31mfail{ESC}[0m plain", [{"text": "fail", "color": "#F87171"}, {"text": " plain"}]),
    ...
    ("real_changed_line", f"{ESC}[0;33mchanged: [host]{ESC}[0m", [{"text": "changed: [host]", "color": "#FCD34D"}]),
    ("bright_equals_normal", f"{ESC}[92mok{ESC}[0m", [{"text": "ok", "color": "#4ADE80"}]),
    ("multi_line", f"line1\n{ESC}[32mline2{ESC}[0m", [{"text": "line1\n"}, {"text": "line2", "color": "#4ADE80"}]),
