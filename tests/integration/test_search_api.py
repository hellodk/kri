...
async def test_search_requires_min_2_chars(admin_client: AsyncClient):
    # Route contract is min_length=2 (UUID-prefix search): 1 char -> 422, 2 chars -> 200.
    response = await admin_client.get("/api/v1/search?q=a")
